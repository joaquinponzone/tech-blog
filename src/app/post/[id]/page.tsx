        ...
        <div className="button-0 absolute p-2 lg:bottom-20 lg:p-6 2xl:left-64">
          <div className="mx-16 w-fit min-w-[300px] max-w-4xl lg:min-w-[400px]">
            <div className="absolute -top-20 left-20 size-full">
              <Link href="/" className={`flex items-center gap-2 ${buttonVariants({ variant: "secondary" })}`}><ArrowLeftIcon/> Blog</Link>
            </div>
        ...
        <div className="flex gap-8 py-32">
          <div className="w-full lg:w-2/3">
            <div className="prose prose-lg max-w-none">
              ...
              <p>Curabatur sit amet sapien et velit fringilla tincidunt porttitor eget lectus. Sed magna libero, malesuada ut velit vitae, porta ac enim.</p>
              <p>Curabatur sit amet sapien et velit fringilla tincidunt porttitor eget lectus. Sed magna libero, malesuada ut velit vitae, porta ac enim. Curabatur sit amet sapien et velit fringilla tincidunt porttitor eget lectus. Sed magna libero, malesuada ut velit vitae, porta ac enim.</p>
              <Image
                src={post.image}
              ...
              <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Fusce sed ante in nunc porttitor aliquet. Sed magna libero, malesuada ut velit vitae, porta ac enim.</p>
              <h2>Nullam tristique tellus porta</h2>
              <p>Maecenas quis ex libero. Sed magna libero, malesuada ut velit vitae, porta ac enim. Curabatur sit amet sapien et velit fringilla tincidunt porttitor eget lectus. Sed magna libero, malesuada ut velit vitae, porta ac enim.</p>
            </div>
          </div>
