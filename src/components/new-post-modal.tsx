                ...
                {done ? (
                    ...
                    <DialogFooter>
                        <div className="flex w-full justify-center">
                            ...
                            }} type="submit" className="hover:text-primary bg-black text-white hover:bg-black" size="lg">
                                Done
                            </Button>
                        </div>
                    </DialogFooter>
                    ...
                    <>
                        <DialogHeader>
                            <DialogTitle className="text-center text-3xl text-black">Upload your post</DialogTitle>
