...
export function NewPostForm({ setDone }: { setDone: () => void }) {
    ...
    return (
        <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)} className="flex w-full flex-col items-center justify-center space-y-6">
                <FormField
                    ...
                    render={({ field }) => (
                        <FormItem className="w-full">
                            <FormControl>
                                <Input disabled={isSubmitting} placeholder="Title" {...field} className="w-full border-2 border-black bg-white text-black" />
                            </FormControl>
                            <FormMessage />
                        </FormItem>
                    )}
                ...
                <FormField
                    ...
                    render={({ field }) => (
                        <FormItem className="w-full">
                            <FormControl>
                                <Button disabled={isSubmitting} onClick={() => inputFileRef.current?.click()} type="button" className="hover:text-primary w-full border-2 border-black bg-transparent hover:bg-black">
                ...
                <Button type="submit" className="hover:text-primary bg-black text-white hover:bg-black" size="lg" disabled={isSubmitting}>
